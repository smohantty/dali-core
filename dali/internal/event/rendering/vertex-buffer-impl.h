...
template<> struct PropertyImplementationType< Property::BOOLEAN > { using Type = bool; };
template<> struct PropertyImplementationType< Property::FLOAT > { using Type = float; };
template<> struct PropertyImplementationType< Property::INTEGER > { using Type = int; };
template<> struct PropertyImplementationType< Property::VECTOR2 > { using Type = Vector2; };
template<> struct PropertyImplementationType< Property::VECTOR3 > { using Type = Vector3; };
template<> struct PropertyImplementationType< Property::VECTOR4 > { using Type = Vector4; };
template<> struct PropertyImplementationType< Property::MATRIX3 > { using Type = Matrix3; };
template<> struct PropertyImplementationType< Property::MATRIX > { using Type = Matrix; };
template<> struct PropertyImplementationType< Property::RECTANGLE > { using Type = Rect<int>; };
template<> struct PropertyImplementationType< Property::ROTATION > { using Type = Quaternion; };
